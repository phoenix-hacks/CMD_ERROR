...
(11) NOT NULL,
  admin_email varchar
(200) COLLATE utf8_unicode_ci NOT NULL,
...
(200) COLLATE utf8_unicode_ci NOT NULL,
  author_status ENUM
('Enable','Disable') COLLATE utf8_unicode_ci NOT NULL,
  author_created_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  author_updated_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
author_id",
"author_name
", "author_status", "author_created_on", "author_updated_on") VALUES
...
(200) COLLATE utf8_unicode_ci NOT NULL,
  book_author varchar
(200) COLLATE utf8_unicode_ci NOT NULL,
  book_location_rack varchar
(100) COLLATE utf8_unicode_ci NOT NULL,
book_name text COLLATE utf8_unicode_ci NOT NULL,
  book_isbn_number varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  book_no_of_copy int
(5) NOT NULL,
  book_status enum
('Enable','Disable') COLLATE utf8_unicode_ci NOT NULL,
  "book_added_on" varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  "book_updated_on" varchar
(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
book_id",
"book_category
", "book_author", "book_location_rack", "book_name", "book_isbn_number", "book_no_of_copy", "book_status", "book_added_on", "book_updated_on") VALUES
...
('Enable','Disable') COLLATE utf8_unicode_ci NOT NULL,
  category_created_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  category_updated_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
category_id",
"category_name
", "category_status", "category_created_on", "category_updated_on") VALUES
...
(30) COLLATE utf8_unicode_ci NOT NULL,
  user_id varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  issue_date_time varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  expected_return_date varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  return_date_time varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  book_fines varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  book_issue_status enum
('Issue','Return','Not Return') COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
issue_book_id",
"book_id
", "user_id", "issue_date_time", "expected_return_date", "return_date_time", "book_fines", "book_issue_status") VALUES
...
(
  location_rack_id int
(11) NOT NULL,
  location_rack_name varchar
(200) COLLATE utf8_unicode_ci NOT NULL,
  location_rack_status enum
('Enable','Disable') COLLATE utf8_unicode_ci NOT NULL,
  location_rack_created_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  location_rack_updated_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
location_rack_id",
"location_rack_name
", "location_rack_status", "location_rack_created_on", "location_rack_updated_on") VALUES
...
INSERT INTO lms_setting (
"setting_id",
"library_name
", "library_address", "library_contact_number", "library_email_address", "library_total_book_issue_day", "library_one_day_fine", "library_issue_total_book_per_user", "library_currency", "library_timezone") VALUES
...
(30) COLLATE utf8_unicode_ci NOT NULL,
  user_verificaton_code varchar
(100) COLLATE utf8_unicode_ci NOT NULL,
  user_verification_status enum
("No","Yes") COLLATE utf8_unicode_ci NOT NULL,
  user_unique_id varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  user_status enum
('Enable','Disable') COLLATE utf8_unicode_ci NOT NULL,
  user_created_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL,
  user_updated_on varchar
(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
"user_contact_no",
"user_profile
", "user_email_address", "user_password", "user_verificaton_code", "user_verification_status", "user_unique_id", "user_status", "user_created_on", "user_updated_on") VALUES
...
--
ALTER TABLE lms_admin
  MODIFY COLUMN admin_id int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT = 2;
...
--
ALTER TABLE lms_issue_book
MODIFY issue_book_id int(11) 
NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table "lms_location_rack"
--
ALTER TABLE lms_location_rack
  MODIFY location_rack_id int
